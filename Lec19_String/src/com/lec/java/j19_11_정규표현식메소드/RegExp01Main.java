...
public class RegExp01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(matcher.replaceFirst("XXXX"));  // -XXXX-
		...
		System.out.println(matcher.replaceFirst("***"));
			// 결과 -***-myABCD--My1234567--MyZZ---My789
		System.out.println(matcher.replaceAll("***"));  // 여러개 매칭시 한꺼번에 치환 가능.
			// 결과 -***-myABCD--***567--***-My789
...
// 참조 : https://nesoy.github.io/articles/2018-06/Java-RegExp
