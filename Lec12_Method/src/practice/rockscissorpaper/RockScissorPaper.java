...
public class RockScissorPaper {
	...
	public static void displayChoice(int user, int com) {
		...
		// 상단 컴퓨터 난수 발생기 확인 결과 동일한 값확인
		System.out.println(getHandType(user) 
				+ " vs " + getHandType(com));
	...
	public static void computeResult(int user, int com) {
		...
		if (user == 1) {
			System.out.println((com == 3) ? "User Win!" : "Com Win!"); 
		} else if (user == 2) {
			System.out.println((com == 1) ? "User Win!" : "Com Win!");
		} else {
