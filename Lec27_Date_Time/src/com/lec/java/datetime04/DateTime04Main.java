...
public class DateTime04Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("현재시간: " + time1);  // 21:06:12.275
		
		// of(hour, minute, second, nanoOfSecond) 주어진 시간
		LocalTime time2 = LocalTime.of(23, 12, 22, 1234567); // 23:12:22.001234567
		System.out.println("주어진시간: " + time2);
		
		System.out.println("\nLocalDateTime");
		LocalDateTime datetime1 = LocalDateTime.now();
		System.out.println("현재날짜시간: " + datetime1); // 2020-09-02T21:23:15.404

		LocalDateTime datetime2 = LocalDateTime.of(2020, 8, 20, 18, 23, 11, 1234);
		System.out.println("주어진날짜시간: " + datetime2); // 2020-09-02T21:23:15.404
