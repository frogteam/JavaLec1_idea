...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		...
		JRadioButton pear = new JRadioButton("배", true);  // 최초에 선택상태로
		JRadioButton cherry = new JRadioButton("체리", cherryIcon);
		cherry.setBorderPainted(true);  // 외곽선
		cherry.setSelectedIcon(selectedCherryIcon);  // '선택상태' 일때의 이미지 설정
