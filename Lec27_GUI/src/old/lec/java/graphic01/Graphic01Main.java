package old.lec.java.graphic01;
// http://www.java2s.com/Tutorial/Java/0261__2D-Graphics/Draw2Dshape.htm
...
public class Graphic01Main extends JFrame{
	Shape shapes[] = new Shape[5];
	  public static void main(String args[]) {
		  Graphic01Main app = new Graphic01Main();
	  }

	  public Graphic01Main() {
