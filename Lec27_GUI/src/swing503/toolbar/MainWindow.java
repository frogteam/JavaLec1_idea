...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		...
		// 컨테이너는 BorderLayout 배치 관리자 .. 여야 하는데 어디있지?
		// 디폴트는 FlowLayout 일텐데..?
	...
	void createToolBar() {
		...
		// 3. JToolBar 컴포넌트를 컨테이너에 배치
		c.add(toolBar, BorderLayout.NORTH);  // 처음에는 위쪽 (NORTH) 에 부착
	} // end createToolBar()
	...
	/*
	 실행하면 초기에는 content pane 의 상단(NORTH) 에 툴바가 부착
	 핸들을 드래그 하여 SOUTH로 이동해보자.
	 핸들을 드래그 하여 임의의 위치로 이동해보자
	 */
