...
import javax.swing.JFrame;   // swing 을 처음 학습할때는 사용할때는 개별 import 추천 
...
public class MainWindow extends JFrame{
	...
	public MainWindow() {
		...
		setExtendedState(JFrame.MAXIMIZED_BOTH);  // NORMAL, ICONIFIED, MAXIMIZED_HORIZ, MAXIMIZED_VERT, MAXIMIZED_BOTH
		setSize(350, 350);  // <-- 줄였을때 이 사이즈로 돌아온다.
		//setUndecorated(true);  // 윈도우 프레임(타이블 바 등..) 보이지 않게 하기   
		setVisible(true);
	}
	...
	public static void main(String[] args) {
		...
		frame1.setTitle("400x300프레임");
		frame1.setSize(400, 300);  // 프레임 크기 (width, height)
		...
		// main 은 종료되지만 프레임창은 종료되기 전까지 어플리케이션이 종료되는건 아니다.
...
class MyFrame1 extends JFrame{
	MyFrame1(){
		...
		//setSize(500, 500);  // 프레임 크기 (width, height)
		setBounds(100, 100, 516, 384);  // 프레임위치+크기 (x, y, width, height)
...
class MyFrame2 extends JFrame{
	MyFrame2(){
		setTitle("500x500 화면 중앙 배치");
		setSize(500, 500);  // 프레임 크기 (width, height)
		setLocationRelativeTo(null);  // setVisible 전에 호출하면
		setVisible(true);  // 프레임 보이기,	
	}
} //end Frame
